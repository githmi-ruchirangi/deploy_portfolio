...
const ClientReviewCard = ({image,role,user}:Props) => {
    ...
    <div className="m-0.5 hover:bg-gray-700 transition-all duration-300 rounded-lg ">
        ...
        <p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Kuis nostrud exercitation
             ullamco laboris nisi ut aliquip ex ea Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p>
