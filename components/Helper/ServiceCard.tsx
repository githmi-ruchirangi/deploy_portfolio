...
const ServiceCard = ({num,title}:Props) => {
    ...
    <div className="bg-black custom_service z-[100] relative transform rounded-2xl text-center p-6 shadow-md">
        ...
        <p className="text-white text-[15px] opacity-60 mt-[0.8rem]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.
        Kuis nostrud exercitation ullamco laboris nisi ut aliquip ex ea</p>
